...
const BADGES: Record<string, ReturnType<typeof require>> = {
  YoungAdults: require('../assets/brand/badgeYoungAdults.png'),
  ELCSAMO: require('../assets/brand/badgeElcsamo.png'),
  PrayerMens: require('../assets/brand/badgePrayerMens.png'),
  PrayerYouth: require('../assets/brand/badgePrayerYouth.png'),
  PrayerWomens: require('../assets/brand/badgePrayerWomens.png'),
}
