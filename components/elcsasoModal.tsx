...
import { styles } from './elcsasoModal.styles'
...
const CHAPTERS = [
  {
    ...
    logo: require('../assets/brand/badgeElcsasoUp.png'),
  },
  {
    key: 'eduvos',
    ...
    logo: require('../assets/brand/badgeElcsasoEduvos.png'),
  },
  {
    key: 'tut',
    name: 'ELCSASO TUT',
    ...
    logo: require('../assets/brand/badgeElcsasoTut.png'),
  },
]
