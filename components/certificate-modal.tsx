...
import { applicationDetailText, type AnyApplication } from '../lib/application-detail'
import { styles } from './certificate-modal.styles'
      ...
      <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
        <View ref={paperRef} style={styles.paper} collapsable={false}>
          <View style={styles.paperInner}>
            <Image source={require('../assets/brand/church-logo.png')} style={styles.crest} resizeMode="contain" />
