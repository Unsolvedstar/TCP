...
export const styles = StyleSheet.create({
  ...
  card: { backgroundColor: colors.white, borderRadius: radius.xl, padding: 22, gap: 14, shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 16, shadowOffset: { width: 0, height: 6 }, elevation: 3 },
