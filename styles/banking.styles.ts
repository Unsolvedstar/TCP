...
export const styles = StyleSheet.create({
  ...
  snapscanError: { fontSize: 12.5, color: colors.danger, fontWeight: '600' },
  snapscanStatusBox: { flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: radius.md, padding: 12, marginTop: 12, borderWidth: 1 },
  snapscanStatusBoxPending: { backgroundColor: colors.g50, borderColor: colors.g100 },
  snapscanStatusBoxCompleted: { backgroundColor: colors.g50, borderColor: colors.g100 },
  snapscanStatusBoxError: { backgroundColor: colors.dangerBg, borderColor: colors.dangerBorder },
  snapscanStatusPendingText: { flex: 1, fontSize: 13, fontWeight: '600', color: colors.g700 },
  snapscanStatusCompletedText: { flex: 1, fontSize: 13, fontWeight: '700', color: colors.g700 },
  snapscanStatusErrorText: { flex: 1, fontSize: 13, fontWeight: '600', color: colors.danger },
  snapscanHistoryRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 9, borderTopWidth: 1, borderTopColor: colors.cream },
  snapscanHistoryDate: { flex: 1, fontSize: 12.5, color: colors.muted },
  snapscanHistoryAmount: { fontSize: 13.5, fontWeight: '700', color: colors.text },
  snapscanHistoryStatus: { fontSize: 10, fontWeight: '800', textTransform: 'uppercase', paddingVertical: 3, paddingHorizontal: 8, borderRadius: 4 },
  snapscanHistoryStatusPending: { color: colors.g700, backgroundColor: colors.g100 },
  snapscanHistoryStatusCompleted: { color: colors.g700, backgroundColor: colors.g100 },
  snapscanHistoryStatusError: { color: colors.danger, backgroundColor: colors.dangerBg },
})
