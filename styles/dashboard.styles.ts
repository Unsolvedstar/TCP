...
export const styles = StyleSheet.create({
  ...
  audienceTag: { fontSize: 9.5, fontWeight: '700', color: colors.muted, backgroundColor: colors.cream, paddingVertical: 2, paddingHorizontal: 6, borderRadius: 4, overflow: 'hidden' },
  ...
  annPoster: { width: '100%', height: 160, borderRadius: radius.md, marginTop: 8, backgroundColor: colors.cream },
